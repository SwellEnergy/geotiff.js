...
exports.GeoTIFFImage = exports.Pool = exports.writeArrayBuffer = exports.fromUrls = exports.fromBlob = exports.fromFile = exports.fromArrayBuffer = exports.fromBuffer = exports.fromUrl = exports.MultiGeoTIFF = exports.GeoTIFF = exports.setLogger = exports.addDecoder = exports.getDecoder = exports.rgb = exports.globals = void 0;
/** @module geotiff */
...
const buffer_js_1 = require("./source/buffer.js");
 ...
 * @returns {Promise<GeoTIFF>} The resulting GeoTIFF file.
 */
async function fromBuffer(buffer, signal) {
    return GeoTIFF.fromSource((0, buffer_js_1.makeBufferSource)(buffer), signal);
}
...
async function fromArrayBuffer(arrayBuffer, signal) {
    return GeoTIFF.fromSource((0, arraybuffer_js_1.makeArrayBufferSource)(arrayBuffer), signal);
}
